    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
           HomeFragment homeFragment=new HomeFragment();
            ...
            FragmentManager fragmentManager =getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment,fountainFragment).commit();
        } else if (id == R.id.nav_slideshow) {
            ChurchesFragment churchesFragment=new ChurchesFragment();
            FragmentManager fragmentManager =getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment,churchesFragment).commit();
