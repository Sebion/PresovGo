...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragmentTransaction.replace(R.id.fragment, fountainFragment);
            ...
            fragmentTransaction.replace(R.id.fragment, churchesFragment);
            fragmentTransaction.commit();
    ...
    @Override
    public void setMyCoordinations(String myCoordinations) {
        this.incomingMessage=myCoordinations;
    }
